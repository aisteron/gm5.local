...
export function $$_(elements) {
	return document.querySelectorAll(elements);
}

export function loadCSS(n, e, o, d) {
	"use strict";
	var t = window.document.createElement("link"),
		i = e || window.document.getElementsByTagName("script")[0],
	...
	return (
		...
		(t.onloadcssdefined = function (n) {
			for (var e, o = 0; o < l.length; o++)
				l[o].href && l[o].href === t.href && (e = !0);
			e
				? n()
				: setTimeout(function () {
...
export async function load_swiper() {
	return new Promise((resolve) => {
		...
		script.setAttribute("tag", "swiper");
...
export async function load_notification() {
	...
	return new Promise((resolve) => {
		...
		let script = document.createElement("script");
		script.src = "/vendors/notify/notifications.js";
		script.setAttribute('notify', "")
		$_(".scripts-area").appendChild(script);
		script.onload = () => {
			let style = loadCSS("/vendors/notify/notifications.css");
			onloadCSS(style, (_) => resolve("assets loaded"));
		};
...
export function show_notification(msg, theme) {
